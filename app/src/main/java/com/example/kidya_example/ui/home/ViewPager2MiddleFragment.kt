...
class ViewPager2MiddleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.item_viewpager2_middle, container, false)
    }
...
//            tvTitle.text = "Item ${it.getInt("color")}"
    ...
    companion object {
        fun newInstance(color: Int): ViewPager2MiddleFragment {
            val fragment = ViewPager2MiddleFragment()
